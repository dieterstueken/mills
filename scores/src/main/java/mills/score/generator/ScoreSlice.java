...
public class ScoreSlice extends MapSlice {
    ...
    public static ScoreSlice newSlice(ScoreSet scores, int index) {
        return new ScoreSlice(scores, index);
    }
    ...
    static List<ScoreSlice> slices(ScoreSet scores) {
    ...
    protected ScoreSlice(ScoreSet scores, int index) {
        super(scores, index);
    }
